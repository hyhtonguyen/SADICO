...
*   **Địa chỉ Local Server của bạn:** `192.168.1.2,1435`
...
2.  Kết nối đến máy chủ SQL của bạn:
    *   **Server name:** `192.168.1.2,1435` (hoặc `localhost,1435` nếu bạn đang chạy trực tiếp trên máy chứa SQL Server).
...
*   **Cấu hình MinIO (Khuyên dùng cho mạng nội bộ Sadico):**
    *   Chạy container MinIO trên máy chủ `192.168.1.2:9000`.
...
*Chúc bạn triển khai và vận hành hệ thống SADICO CMMS thành công! Nếu gặp bất kỳ vấn đề gì về kết nối SQL Server, hãy kiểm tra cài đặt Tường lửa (Firewall) cổng 1435 trên máy chủ 192.168.1.2.*
